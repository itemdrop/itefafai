      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center p-6 bg-white rounded-lg shadow-md border">
            ...
            <p className="text-gray-600">We embrace cutting-edge technologies and creative solutions to stay ahead of the curve.</p>
          </div>
          ...
          <div className="text-center p-6 bg-white rounded-lg shadow-md border">
            ...
            <p className="text-gray-600">We build trust through transparency, honesty, and ethical business practices.</p>
          </div>
          ...
          <div className="text-center p-6 bg-white rounded-lg shadow-md border">
            ...
            <p className="text-gray-600">We strive for perfection in every project, delivering quality that exceeds expectations.</p>
          </div>
        </div>
      </section>
